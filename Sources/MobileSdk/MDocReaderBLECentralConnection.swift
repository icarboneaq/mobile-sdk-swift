//
//  MdocReaderBLECentralConnection.swift
//  AqReader
//
...
public protocol MDocReaderBLECentralConnectionDelegate: AnyObject {
...
class MDocReaderBLECentralConnection: BLEInternalL2CAPConnection {
    private let controlDelegate: MDocReaderBLECentralConnectionDelegate

    /// Initialize a reader peripheral connection.
    init(delegate: MDocReaderBLECentralConnectionDelegate, channel: CBL2CAPChannel) {
